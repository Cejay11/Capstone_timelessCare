<?php
    // Start a session to handle login/logout
    session_start();
?>
...
<body>
    ...
    <header class="header" id="header">
        ...
        <div class="login">
            ...
            <?php else: ?>
                <a href="php/login.php" class="login-logo">
        <img src="images/account.png" alt="Login Logo">
                 </a>
            <?php endif; ?>
        </div>  
    </header>
    ...
    <main>
        <section id="home" class="hero" data-aos="fade-up">
            ...
            <?php if (!isset($_SESSION['username'])): ?>
    <a href="php/register.php" class="button-71" role="button">Sign Up</a>
<?php endif; ?>
